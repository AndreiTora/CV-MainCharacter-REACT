export function getTechChipClass(name) {
  ...
  if (/\bjava\b|spring|hibernate|struts|soap|microservicios|microservices|apis? rest|rest/.test(tech)) return 'tech-chip-backend';
  ...
  if (/maven|jira|confluence|rally software|jenkins|gitlab|git/.test(tech)) return 'tech-chip-devops';
